...
namespace TableView
{
    ...
    public class TableView : Control
    {
        ...
        internal List<TableViewCell> SelectedCells = new List<TableViewCell>();
        internal bool IsDragging;
        internal int selectStartRow;
        internal int selectStartColumn;
        ...
        static TableView()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof (TableView),
                new FrameworkPropertyMetadata(typeof (TableView)));
        }
        ...
        public static readonly DependencyProperty ShowVerticalGridLinesProperty =
            DependencyProperty.Register("ShowVerticalGridLines", typeof (bool), typeof (TableView),
        ...
        public static readonly DependencyProperty ShowHorizontalGridLinesProperty =
            DependencyProperty.Register("ShowHorizontalGridLines", typeof (bool), typeof (TableView),
        ...
        public static readonly DependencyProperty ItemsSourceProperty =
            DependencyProperty.Register("ItemsSource", typeof (IEnumerable), typeof (TableView),
        ...
        public static readonly DependencyProperty SelectedRowIndexProperty =
            DependencyProperty.Register("SelectedRowIndex", typeof (object), typeof (TableView),
        ...
        public static readonly DependencyProperty SelectedColumnIndexProperty =
            DependencyProperty.Register("SelectedColumnIndex", typeof (int), typeof (TableView),
                new FrameworkPropertyMetadata(-1, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault));
        ...
        public static readonly DependencyProperty FocusedRowIndexProperty =
            DependencyProperty.Register("FocusedRowIndex", typeof (object), typeof (TableView),
        ...
        public static readonly DependencyProperty FocusedColumnIndexProperty =
            DependencyProperty.Register("FocusedColumnIndex", typeof (int), typeof (TableView),
                new FrameworkPropertyMetadata(0, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault));
        ...
        public static readonly DependencyProperty FixedColumnCountProperty =
            DependencyProperty.Register("FixedColumnCount", typeof (int), typeof (TableView),
                new FrameworkPropertyMetadata(0,
                    new PropertyChangedCallback(TableView.OnFixedColumnsCountPropertyChanged)));
...
//      set { SetValue(ColumnsProperty, value); }
        ...
        public static readonly DependencyProperty HorizontalScrollOffsetProperty =
            DependencyProperty.Register("HorizontalScrollOffset", typeof (double), typeof (TableView),
                new FrameworkPropertyMetadata(0.0,
                    new PropertyChangedCallback(TableView.OnHorizontalOffsetPropertyChanged)));
        ...
        public static readonly DependencyProperty CellsPanelStyleProperty =
            DependencyProperty.Register("CellsPanelStyle", typeof (Style), typeof (TableView),
                new FrameworkPropertyMetadata(null, new PropertyChangedCallback(TableView.OnCellsPanelStyleChanged)));
        ...
        public static readonly DependencyProperty RowsPanelStyleProperty =
            DependencyProperty.Register("RowsPanelStyle", typeof (Style), typeof (TableView),
                new FrameworkPropertyMetadata(null, new PropertyChangedCallback(TableView.OnRowsPanelStyleChanged)));
        ...
        public static readonly DependencyProperty HeaderPanelStyleProperty =
            DependencyProperty.Register("HeaderPanelStyle", typeof (Style), typeof (TableView),
                new FrameworkPropertyMetadata(null, new PropertyChangedCallback(TableView.OnHeaderPanelStyleChanged)));
        ...
        public static readonly DependencyProperty GridLinesBrushProperty =
            DependencyProperty.Register("GridLinesBrush", typeof (Brush), typeof (TableView),
        ...
        {
            foreach (var tableViewCell in SelectedCells)
            {
        ...
        public void SelectCells(int fromRow, int fromColumn, int toRow, int toColumn)
        {
            for (int n = fromColumn; n < toColumn; n++)
            {
                var column = this.Columns[n];
                //this.RowsPresenter.RowsPanel
            }            
        }
    }
}
