...
namespace TableView
{
    ...
    public class TableViewCell : ContentControl
    {
        ...
        private void UpdateSelection()
        {
            ...
            ParentTableView.SelectedCells.Add(this);
        }
        ...
        protected override void OnMouseLeftButtonDown(MouseButtonEventArgs e)
        {
            ...
            ParentTableView.ClearSelection();

            _column.FocusColumn();
            Focus();

            ParentTableView.IsDragging = true;
            ParentTableView.selectStartColumn = this.ColumnIndex;
            ParentTableView.selectStartRow = ParentTableView.IndexOfRow(ParentCellsPresenter);
        }
        ...
        protected override void OnMouseLeftButtonUp(MouseButtonEventArgs e)
        {
            ...
            ParentTableView.IsDragging = false;
        }
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            if (e.LeftButton == MouseButtonState.Pressed && ParentTableView.IsDragging)
            {
